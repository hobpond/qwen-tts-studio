...
- [`SettingsViewModel`](../../../composeApp/src/desktopMain/kotlin/com/qwen/tts/studio/viewmodel/SettingsViewModel.kt#L55-L118) offers tokenizer plus talker GGUF downloads for Base, CustomVoice, and VoiceDesign variants. [`scanModelNames`](../../../composeApp/src/desktopMain/kotlin/com/qwen/tts/studio/viewmodel/SettingsViewModel.kt#L246-L264) lists only non-tokenizer `qwen-talker-*.gguf` files for model selection.
